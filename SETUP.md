...
1. In your Infisical project, create a folder (e.g. `/crew`) and add the
   secrets above as keys with their values for the `prod` environment.
...
4. On the server:
   ...
   export INFISICAL_SECRET_PATH=/crew
