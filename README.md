...
I'm building [Fendora](https://fendora.io), a DevSecOps startup focused on the
signal-to-noise problem in AppSec tooling. `crew` is the same philosophy applied
to my own content workflow: less noise, better signal, ship daily.
...
Built by [Mohi](https://github.com/) at [Fendora](https://fendora.io).
Find me on [LinkedIn](https://linkedin.com/) and [X](https://x.com/).
